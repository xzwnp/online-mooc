...
public class EduChapterController {
    ...
    @LogRecord(bizId = "#getBizId()", bizType = "课程章节信息", content = "'课程:'+#getCourseName(#eduChapter.courseId)+' 新增了课程章节信息,章节名称:'+#eduChapter.title")
    ...
    @ApiOperation("删除整个章节")
    @RequiresRoles("course_admin")
    @LogRecord(bizId = "#getBizId()", bizType = "课程章节信息", content = "'课程:'+#getCourseName(#eduChapter.courseId)+' 删除了课程章节,章节名称:'+#eduChapter.title")
